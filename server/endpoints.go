...
const (
	...
	// SingleRuleEndpoint returns rule report for provided {organization} {cluster} and {rule_id}
	SingleRuleEndpoint = "organizations/{org_id}/clusters/{cluster}/users/{user_id}/rules/{rule_id}/report"
